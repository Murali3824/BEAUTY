...
const Footer = ({ scrollToSection }) => {
  ...
  const handleNavClick = (id) => {
    if (location.pathname === '/') {
      ...
      // If we're on another page, navigate to main page with section info
      ...
      <div className="section-container">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
          <div className="col-span-1 md:col-span-1">
            ...
            <p className="text-gray-600 mb-6">
              Bringing professional beauty services to small towns across the country.
            </p>
          </div>
          ...
          <div className="col-span-1">
            <h4 className="font-medium text-gray-800 mb-4">Download</h4>
            <ul className="space-y-2">
              <li>
                <a href="#" className="text-gray-600 hover:text-pink-400 transition-colors">
                  App Store
        ...
        <div className="border-t border-gray-200 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-600 text-sm">
            © {new Date().getFullYear()} Beautyluxe. All rights reserved.
          </p>
